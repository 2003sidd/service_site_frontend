...
// get all employee 
export const getEmployee = async (payLoad: employteeRequestInterface) => {
    return post<employteeRequestInterface, genericResponse<paginationEmployeeResponse>>("api/employee/getEmployee", {...payLoad});
}
